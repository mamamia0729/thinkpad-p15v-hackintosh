...
| 2026-05-11 | Stage 5 attempt 2 | HfsPlus.efi "cannot be found" - root cause: faulty USB drive (Generic Flash Disk). Replaced with second USB (VendorCo ProductCode), booted successfully on first try. |
